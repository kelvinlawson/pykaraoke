...
arm-gp2x-linux-gcc -pthread -fno-strict-aliasing -DNDEBUG -O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -D_GNU_SOURCE -fPIC -I/usr/include/python2.4 -I/gp2xsdk/installed/include/SDL -I/gp2xsdk/Tools/arm-gp2x-linux/include/SDL -c _pycdgAux.c -o build/temp.arm-gp2x-linux/_pycdgAux.o || exit
...
arm-gp2x-linux-gcc -pthread -fno-strict-aliasing -DNDEBUG -O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -D_GNU_SOURCE -fPIC -I/usr/include/python2.4 -c _cpuctrl.c -o build/temp.arm-gp2x-linux/_cpuctrl.o || exit
